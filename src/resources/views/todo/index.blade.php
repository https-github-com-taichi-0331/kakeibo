...
.todoSubmit:nth-child(1) {
    background: blue;
}
.todoSubmit:nth-child(2) {
    background: green;
}
.todoSubmit:nth-child(3) {
    background: orange;
}
.todoSubmit:nth-child(4) {
    background: pink;
}
    ...
    <body class="contents">
        <div id="formArea" class="formArea">
            <form method="post" id="todoForm" action="{{ route('todo.add') }}">
                @csrf
                <input type="text" id="todoInput" class="todoInput" name="content" placeholder="TODOを入力する">
                <div>
        ...
        <div id="bucketArea" class="bucketArea" data-action="{{ route('todo.delete') }}">
            <ul class="bucketList">
